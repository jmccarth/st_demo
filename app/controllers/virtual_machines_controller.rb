class VirtualMachinesController < ApplicationController
  ...
  private
    ...
    def virtual_machine_params
      params.require(:virtual_machine).permit(:hostname, :os, :hd, :mem, :cpu, :comments, :server_id, :service_id, service_attributes: [:cost,:id,:startdate,:enddate,:user_id,:servicetype_id])
    end
end
